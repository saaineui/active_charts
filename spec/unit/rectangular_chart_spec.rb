...
module ActiveCharts
  RSpec.describe RectangularChart do
    ...
    let(:options) { { title: 'Pets per Floor', series_labels: ['<b>Floor 1</b>', 'Floor 2'], rows: %w[cats dogs], width: 500, height: 500, label_height: 20, class: 'my-class', data_formatters: %i[delimiter percent rounded] } }
